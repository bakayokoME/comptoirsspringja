...
class CommandeServiceTest {
    ...
    @Test
    void enregistreExpédition() {
        //on enregistre une expédition
        var commande = service.enregistreExpédition(10248);
        // une commande est expédier donc on verifie d'abord que la commande existe
        assertNotNull(commande.getNumero());
